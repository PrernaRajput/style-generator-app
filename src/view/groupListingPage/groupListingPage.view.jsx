    ...
    return (
        <div className='ui-group-page'>
            ...
            {map( widgets, widget => {
                ...
                const className = classNames( 'ui-group-page__widget', `ui-group-page__widget__${widget.name}`, styleClass );
...
export const groupListingPageView = withNetworkState( groupListingPagePreloader, _groupListingPage );
